...
The study employed stratified random sampling technique where 20/30 villages were purposively sampled based on the availability of boreholes. Then, households from each village were randomly sampled based on the Probability Proportional to Size (PPS)[^1], where the sample sizes vary across clusters.
